...
if ($conn) {
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            if(!$uppercase || !$lowercase || !$number || !$specialChars || strlen($pass) < 10) {
                ...
                try {
                    ...
                    //  else{
                    //    echo '<script>alert( "Something Error , Try After Sometime ! 🙁")</script>';
                    //  }
    ...
    if(isset($_POST['Email']) && isset($_POST['Password']) &&isset($_POST['sign_in'])) {
        ...
        try{
            ...
            if($count == 1){
                ...
                if($data['id'] =="1")
                {
                    $_POST["adm_email"]=$data['Email'];
                    $_POST["adm_password"]=$data['Pass'];
                    echo '<script>alert("Login Successful To Admin Page🙂 ")</script>';
...
<body ><div id="shopify-section-show-helper" class="shopify-section"></div><div id="shopify-section-header-template" class="shopify-section"><nav class="panel-menu mobile-main-menu">
        <ul><li>
                ...
                <a href="teeth1.php">منتجات العناية بالأسنان</a></li></ul>>
                        ...
                        <div class="tt-desctop-parent-account tt-parent-box">
                            <div class="tt-account tt-dropdown-obj">
                                ...
                                <div class="tt-dropdown-menu">
                                    ...
                                    <div class="tt-dropdown-inner">
                                        <ul><li><a href="signnew.html"><i class="icon-f-77"></i>تسجيل الدخول</a></li><li><a href="signnew.html"><i class="icon-f-94"></i>انشاء حساب</a></li>
                            ...
                            <div class="tt-desctop-parent-menu tt-parent-box">
                                <div class="tt-desctop-menu tt-hover-01"><nav>
                                        <ul><li class="dropdown selected tt-megamenu-col-02" >
                                                ...
                                                <a href="teeth1.php">منتجات العناية بالأسنان</a></li><li class="dropdown tt-megamenu-col-01" >
                                            </li></ul>
                                    </nav></div>
                            </div>
                        </div>
    ...
    <!-- BEGIN content_for_index --><div id="shopify-section-1530224149715" class="shopify-section index-section"><div class="nomargin container-indent" data-sectionname="index_revolution">
            ...
            <div class="container" id="container" >
                <div class="form-container sign-up-container">
                    <form method="POST" >
                        <h1  id="ggg"  style="color:#cd9575 ;font-family:Bodoni MT ;font-size: 40px;top: 20px " >Create Account</h1>
                        <input type="text" placeholder="Name" name="Name" id="Name"/>
                        <input type="email" placeholder="Email" name="Email" id="Email" />
                        <input type ="password" placeholder="Password" name= "Password" id="Password" />
                        <button style="border-radius: 20px" name="signup" id="signup">Sign Up</button>
                    </form>
                </div>
                <div class="form-container sign-in-container">
                    <form method="POST" name="loginForm" >
                        <h1 id="sign" style="color:#cd9575 ;font-family:Bodoni MT ;font-size: 40px;top: 50px "  >Sign in</h1>
        ...
        <a href="#">Forgot your password?</a>
                        <button style="border-radius: 20px " name="sign_in" id="sign_in">Sign In</button>
                    </form>
                </div>
                <div class="overlay-container">
                    <div class="overlay">
                        ...
                        <div class="overlay-panel overlay-right">
                            <h1  style="color: white;font-family:Bodoni MT ;font-size: 40px " >Hello  Friend</h1>
                            <p >Enter your personal details and start shoping with us</p>
                        ...
                        <div class="tt-row">
                            <div class="tt-col-left"><div class="tt-col-item tt-logo-col">
                                    <a href="/" class="tt-logo tt-logo-alignment">
                                        <img src="https://cdn.salla.sa/VOypj/ExDCt85fz2OYR1hnALR24Ajx3C2XHuPd3vaVkm0M.png"
